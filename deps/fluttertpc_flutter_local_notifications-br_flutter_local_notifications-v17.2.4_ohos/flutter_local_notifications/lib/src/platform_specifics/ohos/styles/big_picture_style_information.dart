...
import '../pixelmap.dart';
import 'default_style_information.dart';

class OhosBigPictureStyleInformation extends OhosDefaultStyleInformation {
  const OhosBigPictureStyleInformation(
      this.bigPicture, {
        this.contentTitle,
        this.summaryText,
  ...
  final OhosPixelMap<Object> bigPicture;
