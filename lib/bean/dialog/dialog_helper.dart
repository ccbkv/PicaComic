...
class KazumiDialog {
  ...
  static Future<T?> show<T>({
    ...
    final ctx = context ?? observer.currentContext ?? App.navigatorKey.currentContext;
  ...
  static void showToast({
    ...
    try {
      ...
      if (overlay == null) {
        debugPrint('Kazumi Dialog Error: No overlay available to show toast');
        return;
      }
  ...
  static Future<T?> showBottomSheet<T>({
    ...
    final ctx = context ?? observer.rootContext ?? observer.currentContext ?? App.navigatorKey.currentContext;
    if (ctx != null && ctx.mounted) {
      try {
