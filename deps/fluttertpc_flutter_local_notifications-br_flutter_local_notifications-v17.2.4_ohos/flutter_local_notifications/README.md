...
Here's all native features that flutter_local_notifications provides to the flutter side.
| System                                                                    | Android |  harmonyOS  | 
|:--------------------------------------------------------------------------|:--------:| :---------: |
| Show plain notification with Payload                                      |    ✅   |   ✅        | 
| Show plain notification that has no title with Payload                    |    ✅   |   ⛔️        |
| Show plain notification that has no body with Payload                     |    ✅   |   ⛔️        |
| Show notification with custom sound                                       |    ✅   |   ✅(需发邮箱申请权限)|  
| Schedule notification                                                     |    ✅   |   ⛔️        |    
| Repeat notification                                                       |    ✅   |   ⛔️        |   
| Show notification from silent channel                                     |    ✅   |   ✅        |
| Show silent notification from channel with sound                          |    ✅   |   ✅        |
| Cancel latest notification                                                |    ✅   |   ✅        |
| Cancel all notifications                                                  |    ✅   |   ✅        |
| Notifications with actions                                                |    ✅   |   ✅        |
| Show notification with text choice                                        |    ✅   |   ⛔️        |
| Show plain notification with payload and update channel description       |    ✅   |   ✅        |
| Show plain notification as public on every lockscreen                     |    ✅   |   ✅        |
| Show plain notification with custom vibration pattern red LED and red icon|    ✅   |   ✅        |
| Show notification that times out after 3 seconds                          |    ✅   |   ✅        |
| Show big picture notification using local images                          |    ✅   |   ✅        |
| Show big picture notification using base64 String for images              |    ✅   |   ✅        |
| Show big picture notification using URLs for Images                       |    ✅   |   ✅        |
| Show big text notification                                                |    ✅   |   ✅        |
| Show messaging otification                                                |    ✅   |   ⛔️        |
| Show LiveView notification                                                |    ✅   |   ⛔️        |
| Show inbox notification                                                   |    ✅   |   ✅        |
| Show grouped notifications                                                |    ✅   |   ✅        |
| Show ongoing notification                                                 |    ✅   |   ⛔️        |
| Show progress notification                                                |    ✅   |   ✅        |
| Show indeterminate progress notification                                  |    ✅   |   ✅        |
| Show notification without timestamp                                       |    ✅   |   ✅        |
| Show notification with custom timestamp                                   |    ✅   |   ✅        |
| Show notification with chronmeter                                         |    ✅   |   ⛔️        |
| Show bypassDnd notification                                               |    ✅   |   ⛔️        |
| Show no float icon notification                                           |    ✅   |   ⛔️        |
| Show full-screen intent notification                                      |    ✅   |   ⛔️        |
| Show full-screen notification                                             |    ✅   |   ⛔️        |
| Start foreground service                                                  |    ✅   |   ⛔️        |
| Start foreground service with blue background notification                |    ✅   |   ⛔️        |
| End foreground service                                                    |    ✅   |   ⛔️        |
